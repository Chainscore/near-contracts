...
use near_sdk::{
    env, ext_contract, log, near_bindgen, require, AccountId, Balance, Gas, PanicOnDefault, CryptoHash,
    PromiseOrValue,
};
...
#[near_bindgen]
impl FungibleTokenReceiver for ChainScore {
...
#[near_bindgen]
impl ValueReturnTrait for ChainScore {
    fn value_please(&self, amount_to_return: String) -> PromiseOrValue<U128> {
